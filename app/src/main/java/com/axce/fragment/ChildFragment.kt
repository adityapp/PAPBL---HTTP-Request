...
import com.axce.R
import com.axce.adapter.ItemAdapter
...
class ChildFragment : Fragment() {
    ...
    private lateinit var adapterLahzada: ItemAdapter
    private lateinit var adapterMovie: MovieAdapter
    private var dataSetLahzada = arrayListOf<Item>()
    ...
    override fun onCreateView(
        ...
        if (status.equals("local")) {
            ...
            adapterLahzada = ItemAdapter(context!!)
        ...
        view.edt_search.addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                if (status.equals("local")){
                    ...
                    adapterLahzada.dataSet = filter as ArrayList<Item>
    ...
    private fun getItem() {
        var result = serviceLahzada.getItem("application/json")
